...
label start:
    scene bg computer
    "Тест гита. Был обычный день. Февраль, так что на улице темно. Я устало серфил по Интернету. Скоро диплом, надо готовиться, так что времени было немного. Хотя... пожалуй, диплом успеется, так что можно и развлечься инди-играми время от времени. Что я и собирался сейчас делать."
