...
image bg theend = "data/bg/theend.png"
...
label start:
    ...
    "Впрочем, сейчас он некстати. Будет звать в ролевку (я – ее мастер, так что без меня они не начнут), а я хотел немного поиграть в одиночку, возможно, допройти наконец Psychonauts."
    ...
    g "Да и ни у кого из нас нет законченных проектов."
...
label concepts:
    ...
    r "Вторая – я, кажется о ней рассказывал. Про метания чувака со странностями. Этакая психологическая мега-идея."
...
label second_concept:
    ...
    r "Но здесь героям надо также бороться с проявлениями собственного характера."
...
label first_ending:
    ...
    "Так и началась работа над нашим новым проектом."
    "Надеюсь, еще увидимся в новых проектах!"
    jump the_end

label second_ending:
    g "Вторая идея хороша, да и близка мне. Начнем с нее."
    r "Отлично, тогда... приступим? :)"
    "Работа закипела. Я начал гораздо больше рисовать, а Рога наконец-то всерьез приступил к программированию."
    "Надеюсь, еще увидимся в новых проектах!"
    jump the_end

label third_ending:
    g "Начнем с чего-то простого."
    r "Что ж, начнем. Но учти, потом мы должны сделать что-то большее!"
    "На том и порешили. Наш проект начался."
    "Надеюсь, еще увидимся в новых проектах!"
    jump the_end
