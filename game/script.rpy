...
label concepts:
    ...
    g "Давай."
    r "Первый – один из самых очевидных. Можно сделать новеллу про Гамин или Коленку, про ее обитателей и жизнь.{p=2.0}Вторая – я, кажется о ней рассказывал. Про метания чувака-пограничника, как ты их называешь. Этакая психологическая мега-идея.{p=2.0}Третье – можно сделать что-то шаблонное. Мне не нравится этот подход, но для первой игры... нам же надо опробовать свои силы?{p=2.0}Наконец, можешь предложить свои идеи :)"
...
label first_concept:
    ...
    r "Ну, тут все понятно из названия. Человек – обычный человек, никак не связанный с Гамином или Коленкой, впервые там регистрируется. И понимает, что попал в совершенно другой мир, полный странных чуваков, которые ненавидят слово \"инди\", начинают день с кода и вообще, зачастую живут по ту сторону экрана. Романтика!"
